...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'data-analyst', 'team-member', 'marketing-manager'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Analysis', path: '/analyses', entity: 'analysis', service: AccessServiceEnum.PROJECT, icon: FiPieChart },
    {
